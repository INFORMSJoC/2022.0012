...
Remark. If you want to obtain the result in Table 2 with the INPUT flag_err = 3, you need to load and unpack the function [randl.m](https://www.mathworks.com/matlabcentral/fileexchange/53397-generation-of-random-numbers-with-laplace-distribution). Then put *randl.m* in the folder `subfun`.
