...
Remark. Before replicating the results of Table 2 with the INPUT flag_err = 3 in ***Step 6*** , please download the function [randl.m](https://www.mathworks.com/matlabcentral/fileexchange/53397-generation-of-random-numbers-with-laplace-distribution) and place it in the folder `subfun`.
